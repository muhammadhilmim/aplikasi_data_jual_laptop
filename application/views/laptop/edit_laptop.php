                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <div class="table-responsive">
                            <h4>ubah data laptop</h4>
                            <br>
                            <?php
                                foreach($editlaptop as $em):
                                    $id = $em->id;
                                endforeach;
                            ?>

        <form action="<?=base_url('laptop/simpan_edit_laptop') ?>" method="post">
        <input type="hidden" name="id" value="<?=$id ?>">
        <div class="form-group" >
            <label>merk</label>
            <input type="text" class="form-control" id="merk" name="merk" value="<?=$em->merk ?>">
